package com.example.taashaadslib.AppUtils;
...
public class GlobalFiles {
    ...
    public static final String DEVICE_MANUFACTURER = "make";
    public static final String DEVICE_MODEL = "model";
    public static final String KIOSK_ID = "kioskid";
    public static final String BUNDLE_ID = "bundleid";
    public static final String DNT = "dnt";
    public static final String URL = "url";
    public static final String LOCATION_SOURCE = "locationsource";
    public static final String PCHAIN = "pchain";
